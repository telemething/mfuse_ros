...
std::map<int, DeviceEnumerator::Device> DeviceEnumerator::getVideoDevicesMap() {
	return getDevicesMap(CLSID_VideoInputDeviceCategory);
}

std::map<int, DeviceEnumerator::Device> DeviceEnumerator::getAudioDevicesMap() {
...
std::map<int, DeviceEnumerator::Device> DeviceEnumerator::getDevicesMap(const GUID deviceClass)
{
...
std::map<int, DeviceEnumerator::Device> DeviceEnumerator::getDevicesMap(const GUID deviceClass)
{
	...
	Device currentDevice;
	currentDevice.id = deviceId;
	currentDevice.deviceName = "FLIR";
	currentDevice.devicePath = "bb";
	deviceMap[deviceId] = currentDevice;  

	deviceId++;
	currentDevice.id = deviceId;
	currentDevice.deviceName = "USB";
	currentDevice.devicePath = "bb";
	deviceMap[deviceId] = currentDevice;  
